...
def _rock_scene(tier: int) -> str:
    return _compact_resource_scene(
        ...
        model_root="rocks",
        model_prefix="rock",
        active_path=f"res://assets/models/resources/rocks/t{tier}_rock_full.glb",
...
{_common_ext_resources()}
[ext_resource type="PackedScene" path="{active_path}" id="8_{model_root}_{model_prefix}_full"]
