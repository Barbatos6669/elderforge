"""Export the currently open T1 tree .blend file to Godot runtime GLBs.

Run from the project root after editing the Blender file:

    blender --background assets/models/resources/trees/t1_tree.blend --python tools/blender/export_t1_tree_asset.py
"""
...
def main() -> None:
    ...
    export_hierarchy("Trunk", TRUNK_EXPORT_PATH)
    export_hierarchy("Leaves", LEAVES_EXPORT_PATH)
    export_hierarchy("T1TreeDepleted", STUMP_EXPORT_PATH)
