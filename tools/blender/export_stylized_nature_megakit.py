r"""Export edited Stylized Nature MegaKit Blend sources to runtime glTF models.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--asset", default="", help="Asset id to export, such as common_tree_1.")
...
def source_files(args: argparse.Namespace) -> list[Path]:
    ...
    raise RuntimeError("Pass --asset, pass --all, or run this script from an opened nature source Blend.")
