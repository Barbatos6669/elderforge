"""Export the currently open T1 rock .blend file to Godot runtime GLBs.

Run from the project root after editing the Blender file:

    blender --background assets/models/resources/rocks/t1_rock.blend --python tools/blender/export_t1_rock_asset.py
"""
...
def main() -> None:
    ...
    export_hierarchy("T1RockFull", FULL_EXPORT_PATH)
    export_hierarchy("T1RockDepleted", DEPLETED_EXPORT_PATH)
